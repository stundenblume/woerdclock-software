...
void adjustTime(){
  //setBrightness(255); // set the brightness of the LEDs

   pushSET_T();


  int timeExtension=0;
  //showS(1+2+4+8+16+32); // show a patern, so you knw you are in this menue
...
byte whichButtonPressed(int val){
  ...
  if (val > 10 && val < (mButtonValue - TOLLERANCE)) button = 1;
